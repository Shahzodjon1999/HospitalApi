...
public class DoctorValidation : AbstractValidator<DoctorRequest>
{
    public DoctorValidation()
    {
        RuleFor(n => n.FirstName)
           ...
           .MaximumLength(20).WithMessage("First name cannot exceed 12 characters.");
        ...
        RuleFor(n => n.LastName)
            ...
            .MaximumLength(20).WithMessage("Last name cannot exceed 12 characters.");
        ...
        RuleFor(n => n.Address)
            ...
            .MaximumLength(20).WithMessage("Address cannot exceed 12 characters.");
        RuleFor(n => n.Position)
            ...
            .MaximumLength(30).WithMessage("Position cannot exceed 12 characters.");
