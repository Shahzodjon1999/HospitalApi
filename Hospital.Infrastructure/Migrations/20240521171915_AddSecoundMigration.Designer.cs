...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20240521171915_AddSecoundMigration")]
    partial class AddSecoundMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domen.Model.Auth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("841569fd-0659-4d33-8d66-8fe6cccfcc03"),
                            IsBlocked = false,
                            Login = "SupperAdmin123",
                            Password = "!@#123#@!",
                            RefreshToken = "",
                            WorkerId = new Guid("4864f4cd-4c2d-4258-ad24-ab363f3e063d")
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domen.Model.Hospital", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("411ef03d-ae2d-49d9-b199-109feb3ed48f"),
                            Location = "Абрешим",
                            Name = "Обласной болница"
                        },
                        new
                        {
                            Id = new Guid("cc240972-dee2-4bcf-a09a-928bd3e49485"),
                            Location = "Гулистон",
                            Name = "Гор болница"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domen.Model.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b65015d7-1718-4370-bb28-e74d3802d6e0"),
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domen.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e157f1c7-87ce-4b0e-87da-d2bc9eefea1c"),
                            Name = "Admin",
                            WorkerId = new Guid("4864f4cd-4c2d-4258-ad24-ab363f3e063d")
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domen.Model.Worker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4864f4cd-4c2d-4258-ad24-ab363f3e063d"),
                            Address = "Panjakent",
                            ...
                            PositionId = new Guid("b65015d7-1718-4370-bb28-e74d3802d6e0")
                        });
                });
